...
``bgpControlPlane.secretNamespace.name`` Helm chart value. If you wish to
create the namespace, you can set the
``bgpControlPlane.secretNamespace.create`` to ``true``.
