...
var (
	...
	backends1   = []lb.Backend{
		*lb.NewBackend(0, lb.TCP, net.ParseIP("10.0.0.1"), 8080, 0),
		*lb.NewBackend(0, lb.TCP, net.ParseIP("10.0.0.2"), 8080, 0),
	}
	backends2 = []lb.Backend{
		*lb.NewBackend(0, lb.TCP, net.ParseIP("10.0.0.2"), 8080, 0),
		*lb.NewBackend(0, lb.TCP, net.ParseIP("10.0.0.3"), 8080, 0),
	}
	backends3 = []lb.Backend{
		*lb.NewBackend(0, lb.TCP, net.ParseIP("fd00::2"), 8080, 0),
		*lb.NewBackend(0, lb.TCP, net.ParseIP("fd00::3"), 8080, 0),
	}
	backends4 = []lb.Backend{
		*lb.NewBackend(0, lb.TCP, net.ParseIP("10.0.0.4"), 8080, 0),
	}
)
...
func (m *ManagerTestSuite) TestHealthCheckNodePort(c *C) {
	...
	localBackend1 := *lb.NewBackend(0, lb.TCP, net.ParseIP("10.0.0.1"), 8080, 0)
	localBackend2 := *lb.NewBackend(0, lb.TCP, net.ParseIP("10.0.0.2"), 8080, 0)
	...
	remoteBackend1 := *lb.NewBackend(0, lb.TCP, net.ParseIP("10.0.0.3"), 8080, 0)
	remoteBackend2 := *lb.NewBackend(0, lb.TCP, net.ParseIP("10.0.0.4"), 8080, 0)
	remoteBackend3 := *lb.NewBackend(0, lb.TCP, net.ParseIP("10.0.0.5"), 8080, 0)
